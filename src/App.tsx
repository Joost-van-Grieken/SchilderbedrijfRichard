...
const services = [
  ...
  },
  {
    ...
    title: 'Binnen schilderwerk & Souswerk',
  ...
  },
  {
    ...
    text: `Houtrot is een schimmel die zich door het hout verspreidt. Op onbeschermd hout kan vocht zich ophopen, waardoor de schimmel kan ontstaan. Soms is dat een klein plekje, soms een groter gebied.\n\nIk haal alle aangetaste houtrot weg en breng epoxy aan om het gat te dichten. Bij grotere gaten vul ik aan met hard hout.`,
